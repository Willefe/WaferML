...
from src.utils import evaluate_model, load_obj, save_obj, upload_file
    ...
    def initiate_model_trainer(self, train_array, test_array, preprocessor_path):
        try:
            ...
            model_report: dict = evaluate_model(
                X=x_train, y=y_train, models=models)
            ...
            preprocessing_obj = load_obj(file_path=preprocessor_path)
